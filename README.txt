...
1.  **Upload:** Upload the `summaraize` folder to the `/wp-content/plugins/` directory, or install directly via the WordPress plugins screen (search for "SummarAIze").
2.  **Activate:** Activate the plugin through the 'Plugins' menu in WordPress.
3.  **Configure:** Go to Settings > SummarAIze. Select your preferred AI provider (OpenAI or Google Gemini) and enter your API key.  That's it!
...
SummarAIze only sends the content of your posts to the selected AI provider for processing.  No personal or sensitive data is transmitted.

== Screenshots ==

1.  Instantly engage readers with summaries displayed above or below your content.
2.  Enhance your site's aesthetics with the sleek dark mode option.
3.  Grab attention with a user-friendly popup summary.
4.  Effortlessly reorder key takeaways with the drag-and-drop interface.
5.  Easily configure your AI provider and API key in the settings.
...
*   Auto-remove empty points from the front-end display.
