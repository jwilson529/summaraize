...
class Summaraize_Admin_Settings {
	...
	public function summaraize_register_settings() {
		...
		} elseif ( 'oneclickcontent' === $ai_provider ) {
			// OneClickContent-specific settings.
			add_settings_field(
				'summaraize_oneclick_license',
				__( 'License Key', 'summaraize' ),
				array( $this, 'summaraize_oneclick_license_callback' ),
				'summaraize_settings',
				'summaraize_settings_section',
				array( 'label_for' => 'summaraize_oneclick_license' )
			);
			// Always register main settings fields for OneClickContent.
			$this->register_summaraize_main_settings_fields();
		}
	}
	...
	/**
	 * Callback for the OneClickContent License Key field.
	 *
	 * @return void
	 */
	public function summaraize_oneclick_license_callback() {
		$value = get_option( 'summaraize_oneclick_license', '' );
		?>
		<input type="text" name="summaraize_oneclick_license" id="summaraize_oneclick_license" value="<?php echo esc_attr( $value ); ?>" placeholder="<?php esc_attr_e( 'Enter your license key here', 'summaraize' ); ?>" />
		<p class="description">
			Enter your OneClickContent license key. For more details, visit 
			<a href="https://oneclickcontent.com/summaraize" target="_blank" rel="noopener noreferrer">oneclickcontent.com/summaraize</a>
		</p>
		<?php
	}
